...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    type: 'preprint',
    tags: [],
    links: [{ label: 'pdf', href: 'https://arxiv.org/abs/2602.03907' }],
  },
  {
    ...
    type: 'preprint',
    tags: ['Hunyuan3D-DiT'],
    links: [{ label: 'pdf', href: 'https://openaccess.thecvf.com/content/ICCV2025/papers/Lai_Unleashing_Vecset_Diffusion_Model_for_Fast_Shape_Generation_ICCV_2025_paper.pdf' }, { label: 'code', href: 'https://github.com/Tencent/Hunyuan3D-2' }, { label: 'project', href: 'http://3d-models.hunyuan.tencent.com/' }],
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    authors: ME + '*, Huiwen Shi*, Bowen Zhang*, Fan Yang, Jiacheng Wang, Hongxu Zhao, Xinhai Liu, Xinzhou Wang, Qingxiang Lin, Jiaao Yu, Lifu Wang, Zhuo Chen, Sicong Liu, Yuhong Liu, Yong Yang, Di Wang, Jie Jiang, Chunchao Guo',
    venue: 'Preprint',
    year: 2024,
    type: 'preprint',
